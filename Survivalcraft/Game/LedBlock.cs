...
namespace Game
{
	public class LedBlock : MountedElectricElementBlock
	{
		...
		private BlockMesh[] m_standaloneBlockMeshesByColor = new BlockMesh[8];

		private BlockMesh[] m_blockMeshesByData = new BlockMesh[64];

		private BoundingBox[][] m_collisionBoxesByData = new BoundingBox[64][];
		...
		public override IEnumerable<CraftingRecipe> GetProceduralCraftingRecipes()
		{
			...
			while (color < 8)
			{
				CraftingRecipe craftingRecipe = new CraftingRecipe
				{
					...
					Description = "Make colored LEDs from copper, glass and paint"
				};
