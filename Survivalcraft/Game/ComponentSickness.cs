...
namespace Game
{
	public class ComponentSickness : Component, IUpdateable
	{
		...
		private float m_sicknessDuration;
		...
		public void NauseaEffect()
		{
			...
			else
			{
				...
				if (!m_lastMessageTime.HasValue || Time.FrameStartTime - m_lastMessageTime > 60.0)
				{
					...
					{
						m_componentPlayer.ComponentGui.DisplaySmallMessage("You feel nauseous", Color.White, blinking: true, playNotificationSound: true);
					});
				}
			}
		}
