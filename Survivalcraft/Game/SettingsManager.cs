...
namespace Game
{
	public static class SettingsManager
	{
		...
		private static ResolutionMode m_resolutionMode;

		private static WindowMode m_windowMode;

		private static Point2 m_resizableWindowPosition;

		private static Point2 m_resizableWindowSize;
