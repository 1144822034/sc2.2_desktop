...
namespace Game
{
	public class HygrometerBlock : Block, IElectricElementBlock
	{
		...
		private BlockMesh m_caseMesh = new BlockMesh();

		private BlockMesh m_pointerMesh = new BlockMesh();

		private Matrix m_pointerMatrix;

		private Matrix m_invPointerMatrix;

		private Matrix[] m_matricesByData = new Matrix[4];

		private BoundingBox[][] m_collisionBoxesByData = new BoundingBox[4][];
