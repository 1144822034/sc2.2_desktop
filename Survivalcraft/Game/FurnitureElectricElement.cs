...
namespace Game
{
	...
	{
		protected FurnitureElectricElement(SubsystemElectricity subsystemElectricity, Point3 point)
			: base(subsystemElectricity, GetMountingCellFaces(subsystemElectricity, point))
		{
		}

		private static IEnumerable<CellFace> GetMountingCellFaces(SubsystemElectricity subsystemElectricity, Point3 point)
		{
