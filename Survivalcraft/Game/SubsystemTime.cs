...
namespace Game
{
	public class SubsystemTime : Subsystem
	{
		...
		private float m_gameTimeDelta;

		private float m_prevGameTimeDelta;

		private float m_gameTimeFactor = 1f;

		private List<DelayedExecutionRequest> m_delayedExecutionsRequests = new List<DelayedExecutionRequest>();
