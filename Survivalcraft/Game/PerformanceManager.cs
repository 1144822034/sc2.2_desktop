...
namespace Game
{
	public static class PerformanceManager
	{
		...
		private static PrimitivesRenderer2D m_primitivesRenderer;

		private static RunningAverage m_averageFrameTime;

		private static RunningAverage m_averageCpuFrameTime;

		private static float? m_longTermAverageFrameTime;

		private static long m_totalMemoryUsed;

		private static long m_totalGpuMemoryUsed;

		private static StateMachine m_stateMachine;

		private static double m_totalGameTime;

		private static double m_totalFrameTime;

		private static double m_totalCpuFrameTime;

		private static int m_frameCount;

		private static string m_statsString;

		private static FrameData[] m_frameData;
