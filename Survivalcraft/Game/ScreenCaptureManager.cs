...
namespace Game
{
	...
	{
		private static readonly string ScreenshotDir = "system:" + Environment.GetFolderPath(Environment.SpecialFolder.MyPictures) + Path.DirectorySeparatorChar + "Survivalcraft";

		private static bool m_captureRequested;

		private static Action m_successHandler;

		private static Action<Exception> m_failureHandler;
