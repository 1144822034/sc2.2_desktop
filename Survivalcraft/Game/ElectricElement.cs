...
namespace Game
{
	public abstract class ElectricElement
	{
		...
		protected ElectricElement(SubsystemElectricity subsystemElectricity, IEnumerable<CellFace> cellFaces)
		{
		...
		protected ElectricElement(SubsystemElectricity subsystemElectricity, CellFace cellFace)
		...
		protected int CalculateHighInputsCount()
		{
			int num = 0;
