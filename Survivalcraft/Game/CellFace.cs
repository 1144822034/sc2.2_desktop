...
namespace Game
{
	public struct CellFace : IEquatable<CellFace>
	{
		...
		private static readonly int[] m_oppositeFaces = new int[6]
		{
			2,
			3,
			0,
		...
		private static readonly Point3[] m_faceToPoint3 = new Point3[6]
		{
			new Point3(0, 0, 1),
			new Point3(1, 0, 0),
			new Point3(0, 0, -1),
		...
		private static readonly Vector3[] m_faceToVector3 = new Vector3[6]
		{
