...
namespace Game
{
	public class PistonBlock : Block, IElectricElementBlock
	{
		...
		private BlockMesh[] m_standaloneBlockMeshes = new BlockMesh[4];

		private BlockMesh[] m_blockMeshesByData = new BlockMesh[48];
		...
		public override string GetDisplayName(SubsystemTerrain subsystemTerrain, int value)
		{
			...
			{
			case PistonMode.Pulling:
				return "Pulling Piston";
			case PistonMode.StrictPulling:
				return "Strict Pulling Piston";
			default:
				return "Piston";
			}
		}
