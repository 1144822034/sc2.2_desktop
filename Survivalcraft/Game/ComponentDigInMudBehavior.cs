...
namespace Game
{
	public class ComponentDigInMudBehavior : ComponentBehavior, IUpdateable
	{
		...
		private ComponentFishModel m_componentFishModel;

		private ComponentSwimAwayBehavior m_componentSwimAwayBehavior;
		...
		private double m_sinkTime;

		private double m_digInTime;

		private double m_digOutTime = -1.0 / 0.0;

		private float m_maxDigInDepth;

		private int m_digInBlockIndex;

		private ComponentBody m_collidedWithBody;
