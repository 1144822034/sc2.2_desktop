...
namespace Game
{
	public class ComponentFlyAwayBehavior : ComponentBehavior, IUpdateable, INoiseListener
	{
		...
		private float ScoreSafePlace(Vector3 currentPosition, Vector3 safePosition, Vector3? lookDirection)
		{
			float num = 16f;
			Vector3 position = m_componentCreature.ComponentBody.Position;
		...
		private bool IsPredator(Entity entity)
		{
