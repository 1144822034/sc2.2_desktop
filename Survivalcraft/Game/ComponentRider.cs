...
namespace Game
{
	public class ComponentRider : Component, IUpdateable
	{
		...
		private Vector3 m_riderOffset;

		private float m_animationTime;

		private bool m_isAnimating;

		private bool m_isDismounting;

		private Vector3 m_targetPositionOffset;

		private Quaternion m_targetRotationOffset;

		private float m_outOfMountTime;
		...
		private float ScoreMount(ComponentMount componentMount, float maxDistance)
		{
