...
namespace Game
{
	...
	{
		private const float m_range = 8f;

		private const float m_speedThreshold = 0.25f;

		private const float m_pollingPeriod = 0.5f;
		...
		private Vector2 m_corner1;

		private Vector2 m_corner2;
		...
		private float CalculateMotionVoltage()
		{
			float num = 0f;
			m_bodies.Clear();
