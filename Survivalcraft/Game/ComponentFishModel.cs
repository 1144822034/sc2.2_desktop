...
namespace Game
{
	public class ComponentFishModel : ComponentCreatureModel
	{
		...
		private ModelBone m_tail1Bone;

		private ModelBone m_tail2Bone;

		private ModelBone m_jawBone;

		private float m_swimAnimationSpeed;

		private bool m_hasVerticalTail;

		private float m_bitingPhase;

		private float m_tailWagPhase;

		private Vector2 m_tailTurn;

		private float m_digInDepth;

		private float m_digInTailPhase;
