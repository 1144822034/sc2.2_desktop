...
namespace Game
{
	...
	{
		private static List<WorldInfo> m_worldInfos = new List<WorldInfo>();

		private static ReadOnlyList<string> m_newWorldNames;

		private static string WorldsDirectoryName = "app:/Worlds";
		...
		private static void RecursiveEnumerateDirectory(string directoryName, List<string> files, List<string> directories, Func<string, bool> filesFilter)
		{
			try
			{
		...
		private static void PackWorld(string directoryName, Stream targetStream, Func<string, bool> filter, bool embedExternalContent)
		{
