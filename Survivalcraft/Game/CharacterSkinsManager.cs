...
namespace Game
{
	...
	{
		private static List<string> m_characterSkinNames = new List<string>();

		private static Dictionary<PlayerClass, Model> m_playerModels = new Dictionary<PlayerClass, Model>();

		private static Dictionary<PlayerClass, Model> m_outerClothingModels = new Dictionary<PlayerClass, Model>();

		public static ReadOnlyList<string> CharacterSkinsNames => new ReadOnlyList<string>(m_characterSkinNames);

		private static string CharacterSkinsDirectoryName => "app:/CharacterSkins";
