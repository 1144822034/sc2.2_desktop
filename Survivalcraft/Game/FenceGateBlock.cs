...
namespace Game
{
	...
	{
		private float m_pivotDistance;

		private string m_modelName;

		private bool m_doubleSided;

		private bool m_useAlphaTest;

		private int m_coloredTextureSlot;

		private Color m_postColor;

		private Color m_unpaintedColor;
		...
		protected FenceGateBlock(string modelName, float pivotDistance, bool doubleSided, bool useAlphaTest, int coloredTextureSlot, Color postColor, Color unpaintedColor)
		{
