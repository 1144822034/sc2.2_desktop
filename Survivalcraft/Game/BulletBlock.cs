...
namespace Game
{
	public class BulletBlock : FlatBlock
	{
		...
		private static string[] m_displayNames = new string[3]
		{
			"Musket Ball",
			"Buckshot",
			"Buckshot Ball"
		...
		private static float[] m_sizes = new float[3]
		{
			1f,
			1f,
			0.33f
		...
		private static int[] m_textureSlots = new int[3]
		{
			229,
			231,
			229
		...
		private static float[] m_weaponPowers = new float[3]
		{
			80f,
			0f,
			3.6f
		...
		private static float[] m_explosionPressures = new float[3];
