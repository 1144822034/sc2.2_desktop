...
namespace Game
{
	public class ComponentAvoidFireBehavior : ComponentBehavior, IUpdateable
	{
		...
		private float m_dayRange;

		private float m_nightRange;

		private Vector3? m_target;

		private float m_circlingDirection = 1f;

		private float m_periodicEventOffset;

		private double m_ignoreFireUntil;
		...
		private Vector3? FindTarget(out float targetScore)
		{
		...
		private float ScoreTarget(Vector3 target)
		{
