...
namespace Game
{
	...
	{
		private ListPanelWidget m_blocksList;

		private LabelWidget m_categoryLabel;

		private ButtonWidget m_prevCategoryButton;

		private ButtonWidget m_nextCategoryButton;

		private ButtonWidget m_detailsButton;

		private ButtonWidget m_recipesButton;
		...
		private int m_listCategoryIndex = -1;
		...
		public override void Update()
		{
			...
			string arg = m_categories[m_categoryIndex] ?? "All Blocks";
			...
			if (num > 0)
			{
				m_recipesButton.Text = string.Format("{0} {1}", num, (num == 1) ? "recipe" : "recipes");
