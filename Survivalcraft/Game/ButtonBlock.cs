	...
	public class ButtonBlock : MountedElectricElementBlock
	{
		...
		public override void Initialize()
		{
			...
			for (int i = 0; i < 6; i++)
			{
				...
				m_blockMeshesByData[num].AppendModelMeshPart(model.FindMesh("Button").MeshParts[0], boneAbsoluteTransform * m, makeEmissive: false, flipWindingOrder: false, doubleSided: false, flipNormals: false, Color.White);
			...
			m_standaloneBlockMesh.AppendModelMeshPart(model.FindMesh("Button").MeshParts[0], boneAbsoluteTransform * m2, makeEmissive: false, flipWindingOrder: false, doubleSided: false, flipNormals: false, Color.White);
		}
		...
		{
			return new ButtonElectricElement(subsystemElectricity, new CellFace(x, y, z, GetFace(value)));
		}
