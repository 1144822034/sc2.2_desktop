...
namespace Game
{
	...
	{
		private Action<object> m_selectionHandler;

		private LabelWidget m_titleLabelWidget;

		private ListPanelWidget m_listWidget;

		private CanvasWidget m_contentWidget;

		private double? m_dismissTime;
