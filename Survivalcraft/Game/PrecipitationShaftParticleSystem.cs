...
namespace Game
{
	public class PrecipitationShaftParticleSystem : ParticleSystemBase
	{
		...
		private const float m_viewHeight = 10f;

		private const int m_particlesCount = 4;
		...
		private Particle[] m_particles = new Particle[4];

		private PrecipitationType m_precipitationType;

		private bool m_isVisible;

		private bool m_isEmpty;

		private float? m_lastViewY;

		private float m_toCreate;
		...
		private int m_yLimit;

		private int m_topmostValue;

		private int m_topmostBelowValue;

		private double m_lastUpdateTime = -1.7976931348623157E+308;

		private float m_lastSkylightIntensity = -3.40282347E+38f;

		private bool m_needsInitialize;
		...
		private void RaycastParticle(Particle particle)
		{
		...
		private void Initialize()
		{
			...
			m_batch = null;
			m_lastSkylightIntensity = -3.40282347E+38f;
