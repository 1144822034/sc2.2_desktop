...
namespace Game
{
	public class ComponentAvoidPlayerBehavior : ComponentBehavior, IUpdateable
	{
		...
		private void SetImportanceLevel(float score)
		{
			m_importanceLevel = MathUtils.Lerp(4f, 8f, MathUtils.Sqrt(score));
		}

		private ComponentCreature FindTarget(out float targetScore)
		{
		...
		private float ScoreTarget(ComponentCreature target)
		{
