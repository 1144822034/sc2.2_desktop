...
namespace Game
{
	public class ArrowBlock : Block
	{
		...
		private static string[] m_tipNames = new string[9]
		{
			"ArrowTip",
			"ArrowTip",
			"ArrowTip",
		...
		private static int[] m_tipTextureSlots = new int[9]
		{
			47,
			1,
			63,
		...
		private static string[] m_shaftNames = new string[9]
		{
			"ArrowShaft",
			"ArrowShaft",
			"ArrowShaft",
		...
		private static int[] m_shaftTextureSlots = new int[9]
		{
			4,
			4,
			4,
		...
		private static string[] m_stabilizerNames = new string[9]
		{
			"ArrowStabilizer",
			"ArrowStabilizer",
			"ArrowStabilizer",
		...
		private static int[] m_stabilizerTextureSlots = new int[9]
		{
			15,
			15,
			15,
		...
		private static string[] m_displayNames = new string[9]
		{
			"Wooden Tip Arrow",
			"Stone Tip Arrow",
			"Iron Tip Arrow",
			...
			"Fire Arrow",
			"Iron Bolt",
			"Diamond Tip Iron Bolt",
			"Explosive Bolt",
			"Copper Tip Arrow"
		};

		private static float[] m_offsets = new float[9]
		{
			-0.5f,
			-0.5f,
			-0.5f,
		...
		private static float[] m_weaponPowers = new float[9]
		{
			5f,
			7f,
			14f,
		...
		private static float[] m_iconViewScales = new float[9]
		{
			0.8f,
			0.8f,
			0.8f,
		...
		private static float[] m_explosionPressures = new float[9]
		{
			0f,
			0f,
			0f,
