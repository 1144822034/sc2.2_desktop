...
namespace Game
{
	public class TerrainContentsGeneratorFlat : ITerrainContentsGenerator
	{
		...
		private Vector2 m_shoreRoughnessFrequency;

		private Vector2 m_shoreRoughnessAmplitude;

		private Vector2 m_shoreRoughnessOctaves;

		private float[] m_shoreRoughnessOffset = new float[4];
