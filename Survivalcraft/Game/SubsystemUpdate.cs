...
namespace Game
{
	public class SubsystemUpdate : Subsystem
	{
		...
		private class Comparer : IComparer<IUpdateable>
		{
		...
		private Dictionary<IUpdateable, UpdateableInfo> m_updateables = new Dictionary<IUpdateable, UpdateableInfo>();

		private Dictionary<IUpdateable, bool> m_toAddOrRemove = new Dictionary<IUpdateable, bool>();

		private List<IUpdateable> m_sortedUpdateables = new List<IUpdateable>();
