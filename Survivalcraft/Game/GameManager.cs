...
namespace Game
{
	...
	{
		private static WorldInfo m_worldInfo;

		private static Project m_project;

		private static SubsystemUpdate m_subsystemUpdate;

		private static ManualResetEvent m_saveCompleted = new ManualResetEvent(initialState: true);
