...
namespace Game
{
	public class TouchInputWidget : Widget
	{
		...
		private Vector2 m_touchLastPosition;

		private Vector2 m_touchOrigin;

		private Vector2 m_touchOriginLimited;

		private bool m_touchMoved;

		private double m_touchTime;

		private int m_touchFrameIndex;
