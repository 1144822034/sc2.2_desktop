...
namespace Game
{
	public class SubsystemSpawn : Subsystem, IUpdateable
	{
		...
		private double m_nextDiscardOldChunksTime = 1.0;

		private double m_nextVisitedTime = 1.0;

		private double m_nextChunkSpawnTime = 1.0;

		private double m_nextDespawnTime = 1.0;

		private Dictionary<Point2, SpawnChunk> m_chunks = new Dictionary<Point2, SpawnChunk>();

		private Dictionary<ComponentSpawn, bool> m_spawns = new Dictionary<ComponentSpawn, bool>();
		...
		private Entity SpawnEntity(SpawnEntityData data)
		{
			try
			{
