...
namespace Game
{
	public class SubsystemExplosivesBlockBehavior : SubsystemBlockBehavior, IUpdateable
	{
		...
		private Dictionary<Point3, ExplosiveData> m_explosiveDataByPoint = new Dictionary<Point3, ExplosiveData>();

		private Sound m_fuseSound;
		...
		private void AddExplosive(Point3 point, float timeToExplosion)
		{
