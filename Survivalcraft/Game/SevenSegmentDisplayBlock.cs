...
namespace Game
{
	public class SevenSegmentDisplayBlock : MountedElectricElementBlock
	{
		...
		private BlockMesh[] m_blockMeshesByFace = new BlockMesh[4];

		private BoundingBox[][] m_collisionBoxesByFace = new BoundingBox[4][];
		...
		public override IEnumerable<CraftingRecipe> GetProceduralCraftingRecipes()
		{
			...
			while (color < 8)
			{
				CraftingRecipe craftingRecipe = new CraftingRecipe
				{
					...
					Description = "Make 7-segment displays from copper, glass and paint"
				};
		...
		public override string GetDisplayName(SubsystemTerrain subsystemTerrain, int value)
		{
			...
			return LedBlock.LedColorDisplayNames[color] + " 7-Segment Display";
		}
