...
namespace Game
{
	...
	{
		private Dictionary<IDrawable, bool> m_drawables = new Dictionary<IDrawable, bool>();

		private SortedMultiCollection<int, IDrawable> m_sortedDrawables = new SortedMultiCollection<int, IDrawable>();
