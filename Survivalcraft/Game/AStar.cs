...
namespace Game
{
	public class AStar<T>
	{
		...
		private DynamicArray<Node> m_nodesCache = new DynamicArray<Node>();

		private DynamicArray<Node> m_openHeap = new DynamicArray<Node>();

		private DynamicArray<T> m_neighbors = new DynamicArray<T>();
		...
		private void BuildPathFromEndNode(Node startNode, Node endNode)
		{
			PathCost = endNode.G;
			Path.Clear();
