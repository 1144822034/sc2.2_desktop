...
namespace Game
{
	public static class MusicManager
	{
		...
		private const float m_fadeSpeed = 0.33f;

		private const float m_fadeWait = 2f;
		...
		private static Mix m_currentMix;
		...
		private static float Volume => SettingsManager.MusicVolume * 0.6f;
		...
		private static void PlayMusic(string name, float startPercentage)
		{
