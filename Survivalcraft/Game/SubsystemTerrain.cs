...
namespace Game
{
	public class SubsystemTerrain : Subsystem, IDrawable, IUpdateable
	{
		...
		private Dictionary<Point3, bool> m_modifiedCells = new Dictionary<Point3, bool>();

		private DynamicArray<Point3> m_modifiedList = new DynamicArray<Point3>();

		private static Point3[] m_neighborOffsets = new Point3[7]
		{
			new Point3(0, 0, 0),
			new Point3(-1, 0, 0),
			new Point3(1, 0, 0),
		...
		private List<BlockDropValue> m_dropValues = new List<BlockDropValue>();
