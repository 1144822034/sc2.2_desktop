...
namespace Game
{
	public class DispenserWidget : CanvasWidget
	{
		...
		private ComponentDispenser m_componentDispenser;

		private ComponentBlockEntity m_componentBlockEntity;

		private GridPanelWidget m_inventoryGrid;

		private GridPanelWidget m_dispenserGrid;

		private ButtonWidget m_dispenseButton;

		private ButtonWidget m_shootButton;

		private CheckboxWidget m_acceptsDropsBox;
