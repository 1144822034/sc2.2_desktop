...
namespace Game
{
	public abstract class StairsBlock : Block, IPaintableBlock
	{
		...
		private BlockMesh[] m_uncoloredBlockMeshes = new BlockMesh[24];

		private BlockMesh[] m_coloredBlockMeshes = new BlockMesh[24];

		private BoundingBox[][] m_collisionBoxes = new BoundingBox[24][];

		private int m_coloredTextureSlot;

		protected StairsBlock(int coloredTextureSlot)
		{
