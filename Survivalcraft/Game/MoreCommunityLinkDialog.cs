...
namespace Game
{
	...
	{
		private LabelWidget m_userLabel;

		private ButtonWidget m_changeUserButton;

		private LabelWidget m_userIdLabel;

		private ButtonWidget m_copyUserIdButton;

		private ButtonWidget m_publishButton;
