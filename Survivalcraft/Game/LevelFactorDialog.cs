...
namespace Game
{
	public class LevelFactorDialog : Dialog
	{
		...
		private LabelWidget m_namesWidget;

		private LabelWidget m_valuesWidget;

		private LabelWidget m_totalNameWidget;

		private LabelWidget m_totalValueWidget;

		private ButtonWidget m_okWidget;
