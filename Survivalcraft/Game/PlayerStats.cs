...
namespace Game
{
	...
	{
		private class StatAttribute : Attribute
		{
		}
		...
		private List<DeathRecord> m_deathRecords = new List<DeathRecord>();
		...
		[Stat]
		public double LowestAltitude = 1.0 / 0.0;

		[Stat]
		public double HighestAltitude = -1.0 / 0.0;
