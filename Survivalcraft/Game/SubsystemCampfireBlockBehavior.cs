...
namespace Game
{
	public class SubsystemCampfireBlockBehavior : SubsystemBlockBehavior, IUpdateable
	{
		...
		private Dictionary<Point3, FireParticleSystem> m_particleSystemsByCell = new Dictionary<Point3, FireParticleSystem>();
		...
		private List<Point3> m_toReduce = new List<Point3>();
		...
		private void AddCampfireParticleSystem(int value, int x, int y, int z)
		{
		...
		private void RemoveCampfireParticleSystem(int x, int y, int z)
		{
		...
		private bool AddFuel(int x, int y, int z, int value, int count)
		{
