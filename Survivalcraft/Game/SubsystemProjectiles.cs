...
namespace Game
{
	public class SubsystemProjectiles : Subsystem, IUpdateable, IDrawable
	{
		...
		private List<Projectile> m_projectilesToRemove = new List<Projectile>();
		...
		private const float BodyInflateAmount = 0.2f;
		...
		private static void CalculateVelocityAlignMatrix(Block projectileBlock, Vector3 position, Vector3 velocity, out Matrix matrix)
		{
