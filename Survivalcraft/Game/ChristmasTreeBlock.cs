...
namespace Game
{
	public class ChristmasTreeBlock : Block, IElectricElementBlock
	{
		...
		private BlockMesh m_leavesBlockMesh = new BlockMesh();

		private BlockMesh m_standTrunkBlockMesh = new BlockMesh();

		private BlockMesh m_decorationsBlockMesh = new BlockMesh();

		private BlockMesh m_litDecorationsBlockMesh = new BlockMesh();
