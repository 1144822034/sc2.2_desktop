...
namespace Game
{
	public class ZipArchive : IDisposable
	{
		...
		private List<ZipArchiveEntry> Files = new List<ZipArchiveEntry>();
		...
		private void WriteLocalHeader(ZipArchiveEntry _zfe)
		{
			long position = ZipFileStream.Position;
		...
		private void WriteCentralDirRecord(ZipArchiveEntry _zfe)
		{
			Encoding uTF = Encoding.UTF8;
		...
		private void Store(ZipArchiveEntry _zfe, Stream _source)
		{
		...
		private void UpdateCrcAndSizes(ZipArchiveEntry _zfe)
		{
			long position = ZipFileStream.Position;
